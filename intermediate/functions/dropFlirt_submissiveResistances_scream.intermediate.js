function dropFlirt_submissiveResistances_scream({scene, Target, isWearingBra, isPublic, isWearingUnderwear, willpower, playerPerversionScore, targetWillForce}) {
  ...
  scene.$if(isPublic, function () {
      ...
      option([{text: "I understand, <Target.Sir_or_Ma'am>."}, {text: "I knew I wouldn't scream. This is what I wanted.", condition: Player.masochist.gt(75)}, {text: "<Target.Sir_or_Ma'am>, I don't know if I can control myself.", condition: Player.masochist.gt(90)}])
      scene.$if(0, function () {
Player.masochist.addEq(          random(0, 2))
          ...
          let Opportunist = scene.lpMod.getFunction('generateCNCActor')(scene, "Opportunist")
...
Player.likes_rough.addEq(1)
                  ...
                  option([{text: "Meekly nod my head yes..."}, {text: "Vigorously, shake my head no, I've reached my breaking point!"}])
                  scene.$if(0, () => {
Player.masochist.addEq(1)
Player.likes_rough.addEq(1)
                      Target.dialogue("Of course my little slut.", 'Excited')
                      narrative(["Blow after blow lands on my butt with a few landing dangerously close to my <Target.dick_or_pussy>.", "Then it happened.", "They landed it directly on my <Target.dick_or_clit>", "The pain surges through my body!"])
                      Player.dialogue("MMMMMMMMMMMMMMMMMMMMMMMMM!!!", 'Pain')
                      Target.dialogue("Oh, I see you enjoyed that as much as I did!", 'Evil')
                      narrative(["They landed another directly on my <Target.dick_or_clit>!", "The pain, once again surges through my body but this time it is quickly overtaken by the most powerful orgasm I have ever felt!", "I lose track of time as it seems like it will never end.", "Slow I start to regain my senses.", "I'm shocked to find I am still extremely aroused!"])
Player.arousal = 88
  ...
  option([{text: "I would do it again without a second though!"}, {text: "I might do it again"}, {text: "I would not do it again for a long time if ever."}, {text: "I would never do it again!"}])
  scene.$if(0, function () {
