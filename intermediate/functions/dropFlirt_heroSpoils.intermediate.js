function dropFlirt_heroSpoils({scene, hero}) {
  ...
  option([{text: "I could use an escort home... wink"}, {text: "Kiss Goodbye"}])
  scene.$if(0, function () {
      Player.moveTo('home')
      narrative("We arrive safely back at my home.")
      narrative("Should I reward my hero?")
      option([{text: "Reward them"}, {text: "Kiss Goodbye"}])
      scene.$if(0, function () {
          scene.$if(          hero.isInterestedIn(Player), function () {
              ...
              scene.$if(              hero.isInterestedIn(Player).and(hero.masochist.lt(-20)), function () {
                  ...
                  option([{text: "Resist anyways"}, {text: "Give in"}, {text: "Ask them to be a bit rougher"}])
                  scene.$if(0, function () {
hero.likes_rough.addEq(                      random(1, 5))
...
hero.likes_rough.addEq(                      random(0, 10))
hero.masochist.subEq(                      random(0, 10))
                      ...
                      Player.exchangeContact(hero)
hero.masochist.subEq(                      random(5, 20))
hero.perversion.addEq(                      random(5, 10))
                  }).$else$if(1, function () {
                          ...
                          Player.exchangeContact(hero)
hero.masochist.subEq(                          random(1, 2))
hero.perversion.addEq(                          random(1, 2))
                      }).$else$if(2, () => {
hero.likes_rough.addEq(                              random(1, 2))
