function drop_flirt_submissive_resistances_toFar({scene, Target, isWearingBra, isPublic, isWearingUnderwear, willpower, playerPerversionScore, targetWillForce}) {
  const {Player, none, $WHERE, narrative, option, random, WHEN} = scene
  narrative(["I put all my effort into breaking free and finally manage to break away from <Target.his_or_her> kiss.", "With tears streaming down my face now."])
  ...
  option([{text: "<Target.He_or_She>'s is right..."}, {text: "NO! <Target.He_or_She> was wrong, this had gone too far...", condition: willpower.sub(playerPerversionScore).gt(50)}])
  scene.$if(0, function () {
