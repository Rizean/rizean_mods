...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Corruption\Scenes\co_wi_sex_shop.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'co_wi_sex_shop'}, (scene) => {
    ...
    scene.start(() => {
        ...
        narrative(`They're heading into an alley - I know this one. It's famous for having many sex shops!`)
        option([
    ...
    scene.timeout(1000, "co_wi_sex_shop")
})
