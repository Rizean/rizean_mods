...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Base\Scenes\sexwork\john_threesome_approaches.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'john_threesome_approaches'}, (scene) => {
    ...
    scene.start(() => {
        ...
        if (0) {
            ...
            if ($WHERE.eq("brothel")) {
                narrative(`Soon enough, I was following them to one of the brothel's rooms.`)
            } else {
                narrative(`Soon enough, I was following them to a nearby motel room.`)
            ...
            Actor.dialogue(`No way, that's too expensive! You have too high an opinion of yourself, honey. I'll find us another whore elsewhere.`, `Angry`)
        }
