...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Base\Scenes\sexwork\porn_shoot_fivesome.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'porn_shoot_fivesome'}, (scene) => {
    ...
    scene.start(() => {
        ...
        narrative(`My co-stars would be <Actor.name>, <Actor2.name>, <Actor3.name> and <Actor4.name> ...`)
        option([
        ...
        if (0) {
            ...
            if (1) {
                if (random(0, 100) < 30) {
                    ...
                    scene.followUp("porn_shoot_fivesome")
                }
            }
        }
    ...
    scene.timeout(96, "porn_shoot_fivesome")
})
