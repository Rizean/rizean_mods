...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Base\Scenes\sexwork\porn_shoot_threesome.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'porn_shoot_threesome'}, (scene) => {
    ...
    scene.start(() => {
        ...
        Actor2.dress()
        Actor2.show(3)
        narrative(`A porn director wants to book me for a threesome SCENE with <Actor.name> and <Actor2.name>...`)
        option([
        ...
        if (0) {
            ...
            if (1) {
                if (random(0, 100) < 30) {
                    ...
                    scene.followUp("porn_shoot_threesome")
                }
            }
        }
    ...
    scene.timeout(48, "porn_shoot_threesome")
})
