...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Base\Scenes\dating\surprise_from_dating.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'surprise_from_dating'}, (scene) => {
    ...
    scene.start(() => {
        ...
        Actor.dialogue(`How would you enjoy being reverse-gangbanged by some of my most beautiful female friends? I have to be there of course.`, `Flirty`)
        option([
    ...
    scene.timeout(500, "surprise_from_dating")
})
