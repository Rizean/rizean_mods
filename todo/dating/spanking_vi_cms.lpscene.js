...
// path D:\other\LifePlay_4_15_64bit\LifePlay\Content\Modules\vin_Base\Scenes\dating\spanking_vi_cms.lpscene

const {LPScene} = require('lifeplayjs')

const scene = new LPScene({name: 'spanking_vi_cms'}, (scene) => {
    ...
    scene.timeout(200, "spanking_vi_cms")
})
